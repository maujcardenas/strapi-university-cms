...
export interface ApiCourseCompletionCourseCompletion
  extends Schema.CollectionType {
...
export interface ApiSegmentSegment extends Schema.CollectionType {
  ...
  attributes: {
    startDateSegment: Attribute.Date;
    finishDateSegment: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::segment.segment',
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    studentEmail: Attribute.Email & Attribute.Unique;
    slug: Attribute.UID<'api::student.student', 'studentName'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubjectSubject extends Schema.CollectionType {
  ...
  attributes: {
    subjectTitle: Attribute.String & Attribute.Unique;
    subjectSyllabus: Attribute.RichText;
    subjectDescription: Attribute.Text;
    subjectFeaturedImage: Attribute.Media;
    ...
    >;
    hoursForCompletion: Attribute.Decimal & Attribute.DefaultTo<48>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::subject.subject',
